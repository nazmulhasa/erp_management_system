    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-3 col-sm-3 col-xs-3 control-label">Select Supplier:</label>
    ...
    <div class="row purchase_report_footer" style=" border-top: 1px solid #e5e5e5;padding-top: 20px;">
        <div class="form-group ">
            <div class="col-sm-offset-5 col-sm-4">
                <a href="<?php echo base_url(); ?>report_controll/show_purchase_return/" type="submit" class="btn btn-success">Show Report</a>
