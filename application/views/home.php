...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>asset/css/new.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini fixed">
        ...
        <div class="wrapper">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        ...
                                        <div class="pull-right">
                                            <a href="<?php echo base_url();?>super_admin/signout/" class="btn btn-default btn-flat">Sign out</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            <a href="<?php echo base_url(); ?>/master_admin/">
                                <i class="fa fa-dashboard"></i> <span>Dashboard</span> <i class="fa fa-angle-left pull-right"></i>
                            </a>
                        </li>
                        <li class="treeview">
                            <a href="<?php echo base_url(); ?>inventory_controll/">
                        ...
                        <li class="treeview">
                            <a href="<?php echo base_url(); ?>account_controll/">
                                <i class="fa fa-files-o"></i>
                                <span>Account</span>
                            </a>
                        </li>
                          <li class="treeview">
                            <a href="<?php echo base_url(); ?>report_controll/">
                                <i class="fa fa-files-o"></i>
                         ...
                         <li class="treeview">
                            <a href="#">
                                <i class="fa fa-cubes"></i> <span>Human Resource</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>account_controll/hr_entry/"><i class="fa fa-circle-o"></i> Employee Entry</a></li>
                                <li><a href="<?php echo base_url(); ?>account_controll/employee_list/"><i class="fa fa-circle-o"></i> Employee List</a></li>
                               </ul>
                        </li>
                         <li class="treeview">
                            <a href="#">
                                <i class="fa fa-cubes"></i> <span>Users</span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url(); ?>account_controll/users_entry/"><i class="fa fa-circle-o"></i> User Entry</a></li>
                                <li><a href="<?php echo base_url(); ?>account_controll/users_list/"><i class="fa fa-circle-o"></i> User List</a></li>
                               </ul>
                        </li>
                      </ul>
                </section>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $title1; ?></a></li>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>asset/function.js"></script>
    </body>
</html>
