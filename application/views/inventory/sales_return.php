...
<div class="row" style="margin: 10px;">
        ...
        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>sales_controll/save_sales_return_entry/">
         <div class="col-md-6" style="margin-top: 15px;">
            <div class="form-group">
                <label for="inputEmail3" class="col-md-4 col-sm-4 col-xs-4 control-label lebel_style_jurnal"> Sales Return No:</label>
                <div class="col-sm-5 col-md-5 col-xs-5">
                <?php
                        if (isset($input_value)) {
                            ?>
                            <input type="text" readonly value="<?php echo $input_value + 1 ?>" name="sales_return_no" class="form-control input_style_journal_entry">
                            <?php
                        } if (isset($input_value1)) {
                            ?>
                            <input type="text" disabled value="<?php echo $input_value1 ?>"class="form-control input_style_journal_entry">
                            <input type="hidden" value="<?php echo $input_value1 ?>" name="sales_return_no">
        ...
        <div class="col-md-6" style="margin-top: 15px;">
            <div class="form-group">
                <label for="inputEmail3" class="col-md-4 col-sm-4 col-xs-4 control-label lebel_style_jurnal"> Sales Return Date:</label>
                <div class="col-sm-5 col-md-5 col-xs-5">
                  <?php
                     if (isset($show_sales_return_date)) {?>
          <input type = "text" disabled value="<?php echo $show_sales_return_date;?>" class = "form-control input_style_journal_entry">
          <input type = "hidden" value="<?php echo $show_sales_return_date;?>" name = "sales_return_date">
                  <?php }
                     else { ?>
                     <input type = "text" required class = "form-control input_style_journal_entry" name = "sales_return_date">
                  <?php } ?>
                   </div>
            </div>
            <div class="form-group">
    ...
    <div class="col-md-12" style="margin-top: 10px;">
        <table class="table table-bordered table-striped responsive text-center">
            ...
            <tbody>
                ...
                <?php
                if (!empty($show_sales_return_entry)):
                    $total_value=0;
                    $total_qty=0;
                    foreach ($show_sales_return_entry as $show_value):
                        ?>
                        <tr>
                            <td><?php echo $show_value->sales_return_id ?></td>
                            <td><?php echo $show_value->sales_return_id ?></td>
                            <td>
                            <?php 
                        ...
                        <?php 
                         ...
                         ?>
                            ...
                            <td>
     <a onclick="return confirm('Are You Sure Want To Delete This Data??')" class="btn btn-danger btn_padding_size" href="<?php echo base_url(); ?>purchase_controll/delete_sales_return_display_item/<?php echo $show_value->sales_return_id."/".$show_value->sales_return_no."/".$show_value->sales_return_date."/".$show_value->select_customer?>">
