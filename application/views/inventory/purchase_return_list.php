<div class="row" style="margin: 22px 0px 0px 0px;border: 1px solid #4a8bc2;padding-bottom: 60px;">
    ...
    <div class="col-md-12" style="margin-top: 10px;">
        <table class="table table-bordered table-striped responsive text-center">
            ...
            <tbody>
                <?php
                if ($show_purchase_return_item):
                     foreach ($show_purchase_return_item as $show_purchase_return_value):
                        ?>
                        <tr>
                            <td>
                              <a href="#">  <?php echo $show_purchase_return_value->purchase_return_no ?> </a></td>
                            <td><?php echo $show_purchase_return_value->purchase_return_date ?> </td>
                            <td><?php echo $show_purchase_return_value->select_supplier ?></td>
                            <td><?php echo $show_purchase_return_value->quantity; ?></td>
                            <td><?php echo $show_purchase_return_value->price_per_unit ?></td>
                            <td class="actions center ">
                                <a href="" class="btn btn-edit bg-black btn_padding_size">
                                    <i class="fa fa-edit"></i> Edit</a>
                                <a onclick="return confirm('Are You Sure Want to Delete?');" href="<?php echo base_url(); ?>purchase_controll/delete_purchase_return_list_item/<?php echo $show_purchase_return_value->purchase_return_id ?>" style="" class="btn btn-danger del btn_padding_size">
