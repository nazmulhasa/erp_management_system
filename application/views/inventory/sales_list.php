        ...
        <table class="table table-bordered table-striped responsive text-center">
            ...
            <thead style="background: #b3d9ff" >
              ...
              <tbody>
                <?php
                if ($show_sales_item):
                    foreach ($show_sales_item as $show_sales_value):
                        ?>
                        <tr>
                           <td>
                              <a href="#">  <?php echo $show_sales_value->sales_no ?> </a></td>
                            <td><?php echo $show_sales_value->sales_date ?> </td>
                            <td><?php echo $show_sales_value->select_customer ?></td>
                            <td><?php echo $show_sales_value->quantity; ?></td>
                            <td><?php echo $show_sales_value->price_per_unit ?></td>
                            <td class="actions center ">
                                <a href="" class="btn btn-edit bg-black btn_padding_size">
                                    <i class="fa fa-edit"></i> Edit</a>
                                <a onclick="return confirm('Are You Sure Want to Delete?');" href="<?php echo base_url(); ?>purchase_controll/delete_sales_list_item/<?php echo $show_sales_value->sales_id ?>" style="" class="btn btn-danger del btn_padding_size">
